...
Polymer({
  _template: html`
    ...
    <paper-dialog id="dialog" modal="">
      ...
      ></p>
      <p
        inner-h-t-m-l="[[localize('about-outline', 'jigsawUrl', 'https://jigsaw.google.com', 'shadowsocksUrl', 'https://shadowsocks.org', 'gitHubUrl', 'https://github.com/orgs/OutlineFoundation/repositories?q=outline', 'redditUrl', 'https://www.reddit.com/r/outlinevpn', 'mediumUrl', 'https://medium.com/jigsaw')]]"
      >
        &gt;
      </p>
      <div class="buttons">
