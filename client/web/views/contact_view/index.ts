...
const UNSUPPORTED_ISSUE_TYPES = new Map([
  [IssueType.NO_SERVER, 'https://support.getoutline.org/client/getting-started/get-access-key'],
  [
    IssueType.CANNOT_ADD_SERVER,
    'https://support.getoutline.org/client/troubleshooting/access-key-issues',
  ],
  [IssueType.BILLING, null],
  [IssueType.CONNECTION, 'https://support.getoutline.org/client/troubleshooting/connection-issues'],
]);
