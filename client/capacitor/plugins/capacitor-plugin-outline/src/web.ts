...
export class CapacitorPluginOutlineWeb extends WebPlugin implements CapacitorPluginOutline {
    async invokeMethod(_options: { method: string; input: string }): Promise<{ value: string }> {
        throw this.unimplemented('Not implemented on web.');
    }

    async start(_options: { tunnelId: string; serverName: string; transportConfig: string }): Promise<void> {
        throw this.unimplemented('Not implemented on web.');
    }
